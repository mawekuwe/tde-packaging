...
Source0:	koffice-l10n_1.6.3.orig.tar.gz
...
%prep
%setup -q -n koffice-l10n-%{version}

for l in %{KDE_LANGS}; do
  for f in koffice-l10n-${l}-*.tar.bz2; do
    tar xjf "${f}"
  done
done
...
%lang(fr) %{_datadir}/apps/koffice/autocorrect/fr.xml
%endif
